...
using eco_tourism_outdoor.Services; // Import the namespace for Entity Framework Core, used for database context
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Outdoor API", Version = "v1" });
...
builder.Services.AddDbContext<EcoTourismOutdoorContext>(options =>
...
builder.Services.AddScoped<IProductOrderInfoService, ProductOrderInfoService>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("v1/swagger.json", "Outdoor API V1");
    });
}
